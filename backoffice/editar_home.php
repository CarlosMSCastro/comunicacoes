...
if (!empty($_POST)) {
    ...
    if (isset($_POST['id']) && isset($_POST['titulo_h1'])) {
        ...
        idu_sql("UPDATE home_conteudo SET titulo_h1 = ?, titulo_h2 = ?, texto = ? WHERE id = ?", 
                [$titulo_h1, $titulo_h2, $texto, $id]);
...
if (isset($_POST['add_from_gallery'])) {
    ...
    $data = date('Y-m-d H:i:s');
    idu_sql("INSERT INTO carousel_topo (imagem, ativo, data_insercao) VALUES (?, ?, ?)", 
            [$imagem, 1, $data]);
    $mensagemSucesso = "Imagem adicionada ao Carousel!";
}

// Buscar imagens já no carousel
$imagensNoCarousel = array_column($carousel, 'imagem');

// Scanear pasta uploads para galeria
              ...
              <div class="card-body">
                <form method="POST" class="conteudo-form">
                  ...
                  <div class="mt-3">
                    ...
                    <textarea name="texto" class="form-control ckeditor-textarea" rows="8"><?= htmlspecialchars($item['texto']) ?></textarea>
                  </div>
...
<div class="container-fluid py-4 mx-auto">
  <div class="pb-4 card shadow-lg border-0">
    ...
    <div class="card-header bg-dark text-white d-flex justify-content-between align-items-center">
      ...
      <div class="offcanvas offcanvas-end" id="offcanvasTFM">
        ...
        <div class="offcanvas-body p-0">
          <iframe src="tfm/tinyfilemanager.php"
    ...
    <div class="card-body" >
      ...
      <ul class="nav nav-tabs mb-4">
        <li class="nav-item">
          <button class="nav-link <?= $activeTab=='carousel'?'active':'' ?>" 
                  data-bs-toggle="tab" 
                  data-bs-target="#tab-carousel" 
                  type="button">
            Carousel Ativo (<?= count($carousel) ?>)
          </button>
        </li>
        <li class="nav-item">
          <button class="nav-link <?= $activeTab=='galeria'?'active':'' ?>" 
                  data-bs-toggle="tab" 
                  data-bs-target="#tab-galeria" 
                  type="button">
            + Adicionar Imagem
          </button>
        </li>
      ...
      <div class="tab-content">
        ...
        <!-- TAB 2 -->
        <div class="tab-pane fade pt-2 pb-4" id="tab-galeria">
          ...
          <div class="mx-auto" style="max-width: 85%;">
            ...
            <?php else: ?>
              ...
              <div class="d-flex justify-content-between align-items-center py-3">
                <div class="alert alert-info mb-0 flex-grow-1" style="max-width:70%">
              ...
              <div class="d-flex flex-wrap gap-2">
                <?php foreach($todasImagens as $img): ?>
                  ...
                  ?>
                  <div class="card shadow-sm <?= $jaNoCarousel ? 'border-success border-2' : '' ?>"
                       style="width:140px;">
                    ...
                    <div class="card-body p-2 text-center">
                      ...
                      <?php else: ?>
                        <form method="POST">
                          <input type="hidden" name="add_from_gallery"
